...
pub struct LoadedGltfMaterial<'a> {
    ...
    index: Option<usize>,
    pbr_metallic_roughness: loaded::material::PbrMetallicRoughnessInfo,
    normal_texture: Option<loaded::material::NormalTextureInfo>,
    occlusion_texture: Option<loaded::material::OcclusionTextureInfo>,
    emissive_texture: Option<loaded::material::EmissiveTextureInfo>,
    emissive_factor: loaded::material::EmissiveFactorInfo
}
...
impl<'a> LoadedGltfBuffer<'a> {
    ...
    pub fn get_gltf(&self) -> Arc<Mutex<LoadedGltf<'a>>> {
        Arc::clone(&self.gltf)
    }
...
impl<'a> LoadedGltfMaterial<'a> {
    ...
    pub fn new_from_material(
        ...
        match pbrmr.base_color_texture() {
            Some(texture) => {
                let info = loaded::material::PbrMetallicRoughnessTextureInfo::new(
        ...
        let pbr_metallic_roughness = loaded::material::PbrMetallicRoughnessInfo::new(
            base_color_texture,
            base_color_factor,
        ...
        match material.normal_texture() {
            Some(texture) => {
                let info = loaded::material::NormalTextureInfo::new(
        ...
        match material.occlusion_texture() {
            Some(texture) => {
                let info = loaded::material::OcclusionTextureInfo::new(texture.strength(), texture.texture().index(), texture.tex_coord() as usize);
        ...
        match material.emissive_texture() {
            Some(texture) => {
                let info = loaded::material::EmissiveTextureInfo::new(texture.texture().index(), texture.tex_coord() as usize);
    ...
    pub fn pbr_metallic_roughness(&self) -> &loaded::material::PbrMetallicRoughnessInfo {
        &self.pbr_metallic_roughness
    }

    pub fn normal_texture(&self) -> &Option<loaded::material::NormalTextureInfo> {
        &self.normal_texture
    }

    pub fn occlusion_texture(&self) -> &Option<loaded::material::OcclusionTextureInfo> {
        &self.occlusion_texture
    }

    pub fn emissive_texture(&self) -> &Option<loaded::material::EmissiveTextureInfo> {
        &self.emissive_texture
    }

    pub fn emissive_factor(&self) -> loaded::material::EmissiveFactorInfo {
...
impl<'a> LoadedGltf<'a> {
    ...
    pub fn get_buffers(&self) -> &Vec<LoadedGltfBuffer<'a>> {
        &self.buffers
    }

    pub fn get_buffers_mut(&mut self) -> &mut Vec<LoadedGltfBuffer<'a>> {
        &mut self.buffers
    }

    pub fn get_buffer_views(&self) -> &Vec<LoadedGltfBufferView<'a>> {
        &self.buffer_views
    }

    pub fn get_buffer_views_mut(&mut self) -> &mut Vec<LoadedGltfBufferView<'a>> {
        &mut self.buffer_views
    }

    pub fn get_accessors(&self) -> &Vec<LoadedGltfAccessor<'a>> {
        &self.accessors
    }

    pub fn get_accessors_mut(&mut self) -> &mut Vec<LoadedGltfAccessor<'a>> {
        &mut self.accessors
    }

    pub fn get_images(&self) -> &Vec<LoadedGltfImage<'a>> {
        &self.images
    }

    pub fn get_images_mut(&mut self) -> &mut Vec<LoadedGltfImage<'a>> {
        &mut self.images
    }

    pub fn get_samplers(&self) -> &Vec<LoadedGltfSampler<'a>> {
        &self.samplers
    }

    pub fn get_samplers_mut(&mut self) -> &mut Vec<LoadedGltfSampler<'a>> {
        &mut self.samplers
    }

    pub fn get_textures(&self) -> &Vec<LoadedGltfTexture<'a>> {
        &self.textures
    }

    pub fn get_textures_mut(&mut self) -> &mut Vec<LoadedGltfTexture<'a>> {
        &mut self.textures
    }

    pub fn get_materials(&self) -> &Vec<LoadedGltfMaterial<'a>> {
        &self.materials
    }

    pub fn get_materials_mut(&mut self) -> &mut Vec<LoadedGltfMaterial<'a>> {
        &mut self.materials
    }
}
